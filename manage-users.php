						...
						<div class="panel panel-primary">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover text-white"" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT user.fullname,user.email,user.password,role.role from  user join role on user.role_id=role.id  ";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title text-white"">Create Users</h2>
  	        	  ...
  	        	  <?php if($error1){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error1); ?> </div><?php }
											...
											<div class="form-group">
												<label class="control-label text-white"">Email ID</label>
												<div class="col-sm-24">
											...
											<div class="form-group">
												<label class="control-label text-white"">Role</label>
												<div class="col-sm-24">
