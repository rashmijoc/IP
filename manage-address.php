				...
				<div class="row">
					<div class="col-md-12">
                      ...
                      <th>Phonenumber</th>
									...
									<?php $sql = "SELECT address.location,address.email,address.phonenumber from  address  ";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title text-white"">Address</h2>


								<div class=" col-4 bg-default panel panel-default">

									<div class="panel-body">
										<form align="left" method="post" name="createsubmit" id="createsubmit" class="form-horizontal" onSubmit="return click();">
  	        	  ...
  	        	  <?php if($error1){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error1); ?> </div><?php }
												...
												<label class="control-label  text-white""> Location</label>
												<div class="col-sm-24">
													<input type="text" class="form-control" name="name" id="location" >
												    <div id="location_warning_message" class="alert alert-warning mt-1 d-none" style="display: none"></div>
                      ...
                      <div class="form-group">
                        <label class="control-label  text-white"">Phonenumber</label>
                        <div class="col-sm-24">
                          <input type="numbet" class="form-control" name="phonenumber" id="phonenumber" required>
                        </div>
                      </div>
