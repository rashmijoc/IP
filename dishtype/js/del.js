...
$(document).ready(function() {
    ...
    $(document).on('click', '.dishtype_delete', function() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'ajax/dishtype_ajax_del.php',
                    data: {
                        id: id
                    },
                    ...
                    success: function(result) {
                        if (result.resultOK == true) {
                            //document.location.href = "/?page=dishtype"; //First option of removing element by refreshing all the page
