        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="img/dish/entree-1.jpg" class="img-fluid" alt="">
                <a href="img/dish/entree-1.jpg" data-lightbox="dish" data-title="App 1" class="link-preview" title="Preview"><i class="ion ion-eye"></i></a>

              </figure>

              <div class="portfolio-info">
                <h4><a href="#">Eggplant-bBaji</a></h4>
                <p>$10</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
                <img src="img/dish/seafood3.jpg" class="img-fluid" alt="">
                <a href="img/dish/seafood3.jpg" class="link-preview" data-lightbox="dish" data-title="Web 3" title="Preview"><i class="ion ion-eye"></i></a>

              </figure>

              <div class="portfolio-info">
                <h4><a href="#">Salmon</a></h4>
                <p>$30</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                <img src="img/dish/entree-2.jpg" class="img-fluid" alt="">
                <a href="img/dish/entree-2.jpg" class="link-preview" data-lightbox="dish" data-title="App 2" title="Preview"><i class="ion ion-eye"></i></a>

              </figure>

              <div class="portfolio-info">
                <h4><a href="#">Chicken Satey</a></h4>
                <p>$15</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="img/dish/mains2.jpg" class="img-fluid" alt="">
                <a href="img/dish/mains2.jpg" class="link-preview" data-lightbox="dish" data-title="Card 2" title="Preview"><i class="ion ion-eye"></i></a>

              </figure>

              <div class="portfolio-info">
                <h4><a href="#">Chiken Pieces</a></h4>
                <p>$25</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
                <img src="img/dish/seafood2.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="img/dish/mains1.jpg" class="img-fluid" alt="">
                <a href="img/dish/mains1.jpg" class="link-preview" data-lightbox="dish" data-title="Card 1" title="Preview"><i class="ion ion-eye"></i></a>

              </figure>

              <div class="portfolio-info">
                <h4><a href="#">Chicken Tandoori</a></h4>
                <p>$35</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
                <img src="img/dish/mains3.jpg" class="img-fluid" alt="">
                <a href="img/dish/mains3.jpg" class="link-preview" data-lightbox="dish" data-title="Card 3" title="Preview"><i class="ion ion-eye"></i></a>

              </figure>

              <div class="portfolio-info">
                <h4><a href="#">Whole Chicken</a></h4>
                <p>$45</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                <img src="img/dish/seafood1.jpg" class="img-fluid" alt="">
                <a href="img/dish/seafood1.jpg" class="link-preview" data-lightbox="dish" data-title="Web 1" title="Preview"><i class="ion ion-eye"></i></a>

              </figure>

              <div class="portfolio-info">
                <h4><a href="#">Prawan</a></h4>
                <p>$15</p>
              </div>
            </div>
          </div>
  ...
  <div class="col-md-6">
          ...
          <div class="owl-carousel testimonials-carousel">
            ...
            <div class="testimonial-item">
              <img src="img/person_2.jpg" class="testimonial-img" alt="">
              <h3>Saul Goodman</h3>
              <h4>Ceo &amp; Founder</h4>
              <p>
            ...
            <div class="testimonial-item">
              <img src="img/person_3.jpg" class="testimonial-img" alt="">
              <h3>Sara Wilsson</h3>
              <h4>Designer</h4>
              <p>
                <img src="img/quote-sign-left.png" class="quote-sign-left" alt="">
            ...
            <div class="testimonial-item">
              <img src="img/person_4.jpg" class="testimonial-img" alt="">
              <h3>Jena Karlis</h3>
              <h4>Store Owner</h4>
              <p>
                <img src="img/quote-sign-left.png" class="quote-sign-left" alt="">
            ...
            <div class="testimonial-item">
              <img src="img/team4.jpg" class="testimonial-img" alt="">
              <h3>Matt Brandon</h3>
              <h4>Customer</h4>
              <p>
                <img src="img/quote-sign-left.png" class="quote-sign-left" alt="">
            ...
            <div class="testimonial-item">
              <img src="img/team1.jpg" class="testimonial-img" alt="">
              <h3>John Larson</h3>
              <h4>Customer</h4>
              <p>
                <img src="img/quote-sign-left.png" class="quote-sign-left" alt="">
   ...
   <header class="section-header">
  		...
  		<div>
            ...
            <div class="form-group row">
  					 ...
  					 <div class="form-group row">
                          <div class="col-md-10 ml-5">
                              <textarea type="text" id="comment" class="form-control" name="comment" value="" rows="5" placeholder="Comment" required></textarea>
                              <div id="plate_number_warning_message" class="text-danger mt-1 d-none"></div>
                          </div>
                      </div>
  					<div class="col-md-10 ml-5">
                          <button type="button" class="btn btn-success car" required>
                              Send Message
                          </button>
                      </div>
...
<!--<a href="#register_form">Create your account ➡ </a>-->
<a  href="#" data-toggle="modal" data-target="#register">Create your account</a>
</span>
    </div>
...
<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="register" aria-hidden="true">
  ...
  <img class="avatar-login" src="img/avatar-e.png" alt="Avatar" class="avatar">
                          <div class="form-group">
                              <div id="message" class="alert alert-danger mt-1 d-none align-middle text-center"></div>
                          </div>
                          ...
                          <div class="row">
                               <div class="col-md-18 ">
                                  <label for="fullName">NAME</label>
                                   <input name="fullname" class="form-control" type="text" placeholder="Name*" required >
        ...
        <div class="modal-footer">
  	  <button type="button" id="submit_register" class="btn btn-primary">
          Register
                              </button>
      ...
      <div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="register" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="content modal-popout-bg">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle"> Register</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
