...
$(document).ready(function() {
    ...
    $(document).on('click', '.dish_delete', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.resultOK == true) {
                            //document.location.href = "/?page=dish"; //First option of removing element by refreshing all the page
