    ...
    <div class="container-fluid">
		<div class="row">
			<div class="col-lg-5 ml-5">
				<div class="row">
					<div class="col-lg-2"><img src="/ip/img/LOGO.jpg" style="width:100%"/></div>
...
<div class="col-md-12 ">
		<div class='btn-group pull-right'>
						  <button   class='btn btn-warning'  >
							<a  href="#" data-toggle="modal" data-target="#exampleModalCenter">ADD</a>
						  </button>
						  </div>
				</div>
	<div class="table-responsive" id="dish_data"></div>
    ...
    <div class="modal-content modal-popout-bg">
      <div class='modal-content'>
        ...
        <div class='modal-body'>
			  ...
			  <div class="form-group row">
                    ...
                    <div class='form-group row'>
						...
						<input type='file' id='myfile"' class='btnUpload' name='myfile' class='form-control-file form-control-sm p-1 mr-sm-2 btn-sm my-2 custom-file-input my-sm-0' >
        ...
        <div class='modal-footer'>
		  <button type='button' class='btn btn-success dish_add' data-action='Add'>Add</button>
