						...
						<div class="panel panel-primary">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover text-white"" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT services.servicesname,services.detail from  services  ";
										...
										<tr>
											...
											<td><?php echo htmlentities($result->servicesname);?></td>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title text-white"">Create Services</h2>
  	        	  ...
  	        	  <?php if($error1){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error1); ?> </div><?php }
												...
												<label class="control-label  text-white"">Service Name</label>
												<div class="col-sm-24">
										 	...
										 	<div class="form-group">
												<label class="control-label  text-white"">Detail</label>
												<div class="col-sm-24">
													<input type="text" class="form-control" name="detail" id="password" required>
												</div>
											</div>
